...
function useActivitySearch(categories, radius, location, limit, start_date) {
    const [events, setEvents] = useState([]);
    const [amounteventResults, seteventAmountResults] = useState();
    const [searcheventParams, seteventSearchParams] = useState({categories, radius, location, limit, start_date});
